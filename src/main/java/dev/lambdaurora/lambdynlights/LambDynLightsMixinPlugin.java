...
public class LambDynLightsMixinPlugin implements IMixinConfigPlugin {
	...
	public LambDynLightsMixinPlugin() {
		...
		boolean sodium05XInstalled = LambDynLightsCompat.isRubidium07XInstalled();
		...
		boolean fabricApiInstalled = LambDynLightsCompat.isForgifiedFabricApiInstalled();
		this.conditionalMixins.put("dev.lambdaurora.lambdynlights.mixin.fabric.AoCalculatorMixin", fabricApiInstalled);
	}
